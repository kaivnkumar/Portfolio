...
function Navbar() {
  ...
  return (
    <div className="h-16 w-screen bg-gradient-to-r from-violet-500 via-slate-400 to-stone-300 fixed overflow-hidden">
      <div className="justify-between items-center shadow-header_box h-[72px] flex pl-[80px] pr-[40px] md:pl-[36px] sm:h-[36px] sm:pl-[12px] sm:pr-[10px]">
        ...
        <div>
          <div className="pt-[43px] pb-[22px] text-[17px] text-gray-700 font-bold md:pr-[30px] md:text-[14px] 
